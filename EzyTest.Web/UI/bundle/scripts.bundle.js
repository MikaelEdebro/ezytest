...
var KnockoutService = function () {
    function KnockoutService() {
        classCallCheck(this, KnockoutService);
    }

    createClass(KnockoutService, null, [{
        key: "registerComponent",
        value: function registerComponent(name, viewModel, template) {
            var componentConfig = {
                template: template,
                viewModel: viewModel
            };

            if ((typeof viewModel === "undefined" ? "undefined" : _typeof(viewModel)) === "object") {
                // allow the possibility to pass in both functions and POJO
...
var template = "﻿<div class=\"dashboard\">\r\n    <div data-bind=\"foreach: tasks\">\r\n        <div class=\"task\" data-bind=\"css: {approved: approved(), disapproved: approved() == false}\">\r\n            <h3>Task <span data-bind=\"text: ($index() + 1)\"></span></h3>\r\n            <div class=\"question\">\r\n                <b>Fråga: </b>\r\n                <i data-bind=\"text: question\"></i>\r\n            </div>\r\n            <div class=\"answer\">\r\n                <b>Svar: </b>\r\n                <div data-bind=\"html: answer\"></div>\r\n            </div>\r\n            <div data-bind=\"if: component\">\r\n                <div data-bind=\"component: component\"></div>\r\n            </div>\r\n\r\n            <ezy-rate-task params=\"approved: approved\"></ezy-rate-task>\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"summary\">\r\n        <button type=\"button\" class=\"btn btn-info\" data-bind=\"click: createSummary\">Create summary</button>\r\n        <div class=\"result\" data-bind=\"html: finalResult\"></div>\r\n    </div>\r\n\r\n</div>";
...
var Dashboard = function () {
    function Dashboard() {
        ...
        var viewModel = {
            tasks: knockoutLatest_debug.observableArray(this.getTasks()),
            finalResult: knockoutLatest_debug.observable(),
    ...
    createClass(Dashboard, [{
        ...
        value: function getTasks() {
            ...
            tasks.push({
                ...
                answer: "Jag har dessvärre inte jobbat med kryptering så jag kan dessvärre bara spekulera vilt.<br>Några tänkbara scenarier jag skulle kika på är dock ifall några inställningar på servrarna diffar, t ex encoding eller dylikt.",
                component: null,
                approved: knockoutLatest_debug.observable(null)
            });
            tasks.push({
            ...
            tasks.push({
                ...
                answer: "Entity framework itererar över alla rader ifall man kör .ToList(). Så i detta fall är Version 2 bättre för prestandan.",
                component: null,
                approved: knockoutLatest_debug.observable(null)
            });
            tasks.push({
            ...
            tasks.push({
                ...
                answer: "\n            Detta k\xE4nns som ett gigantiskt \xE4mne som skulle bli ett helt A4. \n            Det \xE4r dock ett \xE4mne som jag brinner f\xF6r, och som jag mer \xE4n g\xE4rna ber\xE4ttar hur jag till\xE4mpar detta \xF6ver en kopp kaffe. :)\n            ",
                component: null,
                approved: knockoutLatest_debug.observable(null)
            });
            tasks.push({
                ...
                answer: "\n            Risken finns att prestandan kan bli lidande eftersom man m\xE5ste s\xF6ka igenom listan med blockade IP (som kan bli l\xE5ng) varje g\xE5ng ngn g\xF6r en s\xF6kning.<br>\n            Just i den d\xE4r koden kan jag inte riktigt se hur metoden AddIpToDictionary() tillf\xF6r ngt, eftersom den new:as upp vid varje nytt s\xF6k?\n            ",
                component: null,
                approved: knockoutLatest_debug.observable(null)
            });
            tasks.push({
                ...
                answer: "Created a Knockout component. Please see /ui/app/better-example and reminder.service.js.",
            ...
            tasks.push({
                ...
                answer: "Created a Knockout component. Click button below. For src, see /ui/app/exchange-rates and ExchangeRatesController.cs",
...
var template$1 = "﻿<div class=\"exchange-rates\">\r\n    <button type=\"button\" class=\"btn btn-primary\" data-bind=\"click: getExchangeRates\">Fetch exchange rates</button>\r\n\r\n    <div data-bind=\"foreach: rates\">\r\n        1 <span class=\"from\" data-bind=\"text: code\"></span> = <span class=\"to\" data-bind=\"text: rate\"></span> SEK<br>\r\n    </div>\r\n\r\n    <ezy-loader params=\"showLoader: showLoader, text: 'Simulating delay and fetching data...'\"></ezy-loader>\r\n</div>";

var ExchangeRates = function () {
    function ExchangeRates() {
        classCallCheck(this, ExchangeRates);


        var viewModel = {
            rates: knockoutLatest_debug.observableArray(),
            currencyTo: knockoutLatest_debug.observable(),
            showLoader: knockoutLatest_debug.observable(false),
    ...
    createClass(ExchangeRates, [{
        key: "getExchangeRates",
        value: function getExchangeRates() {
            var self = this;
            var exchangeRateApiUrl = "/api/exchangerates";
            ...
            setTimeout(function () {
                ...
                jquery.getJSON(exchangeRateApiUrl, exchangeRateRequest).done(function (response) {
...
var ReminderService = function () {
    function ReminderService() {
        classCallCheck(this, ReminderService);
    }

    createClass(ReminderService, null, [{
        key: "remindUser",
        value: function remindUser(seconds, callback) {
            var milliseconds = seconds * 1000;
            var message = "You have now been on the page for " + seconds + " seconds";
...
var template$2 = "<div class=\"better-example\">\r\n    <h2 data-bind=\"text: greeting\"></h2>\r\n\r\n    <button type=\"button\" class=\"btn btn-primary\" data-bind=\"click: initReminder, text: reminderButtonText\"></button>\r\n    <button type=\"button\" class=\"btn btn-primary\" data-bind=\"click: showList\">Load list</button>\r\n\r\n    <ul data-bind=\"visible: listVisible, foreach: listItems\">\r\n        <li data-bind=\"click: function() { $parent.showAlert($index() + 1) }, text: ($index() + 1)\"></li>\r\n    </ul>\r\n\r\n    <p>Time is: <span data-bind=\"text: currentTime\"></span></p>\r\n</div>";

var BetterExample = function () {
    function BetterExample() {
        classCallCheck(this, BetterExample);


        var viewModel = {
            listItems: knockoutLatest_debug.observableArray(new Array(10)),
            greeting: "The fantastic javascript example",
            currentTime: knockoutLatest_debug.observable(new Date(new Date().getTime()).toLocaleTimeString()),
            listVisible: knockoutLatest_debug.observable(false),
            initReminder: this.initReminder,
            reminderButtonText: knockoutLatest_debug.observable("Start reminder timer"),
    ...
    createClass(BetterExample, [{
        key: "initReminder",
        value: function initReminder() {
            var self = this;
            var reminderTimeoutInSeconds = 10;
            var buttonCounter = reminderTimeoutInSeconds - 1;
        ...
        key: "showAlert",
        value: function showAlert(index) {
            if (index === 5) {
                alert("five");
            } else {
                alert(index);
...
var RateTask = function RateTask() {
    classCallCheck(this, RateTask);


    var viewModel = function viewModel(params) {
        this.approved = knockoutLatest_debug.observable(params.approved);
...
var template$4 = "﻿<div class=\"loader\" data-bind=\"if: showLoader\">\r\n    <img src=\"/ui/img/ajax-loader.gif\" alt=\"Loading...\">\r\n    <p class=\"loader-text\" data-bind=\"text: text\"></p>\r\n</div>";

var Loader = function Loader() {
    classCallCheck(this, Loader);


    var defaultLoaderText = "Loading...";
    ...
    KnockoutService.registerComponent("ezy-loader", viewModel, template$4);
};
